...
import { jobCategories, jobTypesSelect } from "@/constants";
...
import useCreateJobMutation from "@/features/job/mutations/use-create-job.mutation";
import {
  insertJobSchema,
  InsertJobType,
            ...
            <Card className="px-6 shadow-lg h-full">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="p-0 flex gap-x-5 justify-between">
                  ...
                  >
                    {isJobCreating ? "creating..." : "submit form"}
                  </Button>
                </div>
              </div>
