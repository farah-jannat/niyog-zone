...
const AuthWelcome = (props: Props) => {
  ...
  return (
    <div className="p-2 pr-0 h-full hidden xl:block">
      <div className="relative z-10 overflow-hidden flex flex-col items-center h-full justify-center  gap-[22px] text-[#35373F] text-[16px] rounded-[8px] card-gradient-bluish bg-[#EAF2F4] ">
        <h3 className="text-[40px] font-bold">{title}</h3>
        <p className="max-w-[431px] text-center">{subTitle}</p>
